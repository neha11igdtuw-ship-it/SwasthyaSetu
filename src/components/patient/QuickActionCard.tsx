...
export function QuickActionCard({
  ...
  const colorStyles = {
    ...
    rose: "bg-rose-50 border-rose-100 text-rose-700 group-hover:bg-rose-700 group-hover:text-white",
    indigo: "bg-indigo-50 border-indigo-100 text-indigo-700 group-hover:bg-indigo-700 group-hover:text-white",
  };

  return (
    <Link
      href={href}
      className="group bg-white rounded-2xl p-4 border border-slate-200/80 shadow-xs hover:shadow-md hover:border-teal-500/50 transition-all flex flex-col justify-between"
    >
      <div>
        ...
        <h4 className="font-extrabold text-slate-900 text-sm group-hover:text-teal-800 transition-colors">
          {title}
        </h4>
