          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
            <div>
              ...
              <input
                ...
                className="w-full p-2.5 rounded-xl border border-slate-200 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-teal-500 font-medium"
              />
            </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            <label className="flex items-center gap-3 p-3 rounded-xl border border-slate-200 bg-slate-50/50 hover:bg-slate-100/50 cursor-pointer">
              ...
              />
              <span className="font-semibold text-slate-800">{t("severeContinuousHeadache")}</span>
            </label>
            ...
            <label className="flex items-center gap-3 p-3 rounded-xl border border-slate-200 bg-slate-50/50 hover:bg-slate-100/50 cursor-pointer">
              <input
                ...
                className="w-4 h-4 accent-teal-700"
              />
              <span className="font-semibold text-slate-800">{t("blurredVisionOrSpots")}</span>
            </label>
            ...
            <label className="flex items-center gap-3 p-3 rounded-xl border border-slate-200 bg-slate-50/50 hover:bg-slate-100/50 cursor-pointer">
              <input
                ...
                className="w-4 h-4 accent-teal-700"
              />
              <span className="font-semibold text-slate-800">{t("swellingFaceHandsFeet")}</span>
            </label>
            ...
            <label className="flex items-center gap-3 p-3 rounded-xl border border-slate-200 bg-slate-50/50 hover:bg-slate-100/50 cursor-pointer">
              <input
                ...
                className="w-4 h-4 accent-teal-700"
              />
              <span className="font-semibold text-slate-800">{t("severeAbdominalPain")}</span>
            </label>
