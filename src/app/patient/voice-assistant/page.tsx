  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <PageHeader
        ...
        subtitle="Tell us your symptoms by speaking in your local language"
        roleBadge={<RoleBadge role="Patient" />}
      />

      <DisclaimerCard
        text="Voice assistance helps users tell symptoms easily. Final health assessment requires doctor or health worker review."
        variant="amber"
      />
      ...
      <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200/80 shadow-sm text-center space-y-6">
        <div className="space-y-2 max-w-md mx-auto">
          ...
          <p className="text-xs text-slate-500">
            Speak in Hindi, Bhojpuri, Maithili, or English. Press the microphone button below to start.
          </p>
        </div>
        ...
        <div className="py-4 flex flex-col items-center justify-center">
          <button
            ...
            aria-label="Change language or speak"
            className={`w-28 h-28 rounded-full flex flex-col items-center justify-center transition-all shadow-md ${
              isRecording
          ...
          <span className="text-xs font-semibold text-slate-600 mt-3">
            {isRecording ? "Listening to your voice..." : "Click to speak symptoms"}
          </span>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 text-left space-y-2">
          ...
          <p className="text-[11px] text-slate-500 italic">
            English Translation: “I have had a severe headache since last night and blurred vision. There is also mild pain in my lower abdomen.”
          </p>
        </div>
        ...
        <div className="pt-4 border-t border-slate-100 space-y-2 text-left">
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="Type your symptoms here (e.g. सिरदर्द, चक्कर आना)..."
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-900 text-white text-xs font-bold inline-flex items-center gap-1"
            >
        ...
        <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2 text-xs text-amber-800 bg-amber-50 px-3 py-1.5 rounded-lg border border-amber-200">
            ...
            <span>Ready for initial health check</span>
          </div>
          ...
          >
            <span>Proceed to Symptom Checklist</span>
